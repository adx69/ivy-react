...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Ivy Wallet
                {/* <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">A Fantastic Money Manager</h3>
            <p className="home__description">
                Imagine Ivy Wallet as a manual expense tracker that will replace
                the good old spreadsheet for managing your personal finance.
            </p>

            <a href="https://play.google.com/store/apps/details?id=com.ivy.wallet"
                className="button button--flex">Try Now
                <svg
                    class="button__icon"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
