...
import "./about.css";
import AboutImg from "../../assets/ivy2.webp";
...
const About = () => {
    return (
        <section className="about section" id="about">
            ...
            <span className="section__subtitle">Our Purpose</span>
            ...
            <div className="about__container container grid">
                ...
                <div className="about__data">
                    ...
                    {/* <a download="" href="#contact" className="button button--flex" target="_blank" rel="noopener noreferrer"> */}
                    <a href="https://github.com/Ivy-Apps/ivy-wallet" className="button button--flex">
                        Github
                        <svg
                            class="button__icon"
